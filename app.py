...
def main():
    ...
    # --- SEKMELER (SIRALAMA: YENİLER ÖNDE, ESKİLER ARKADA) ---
    tabs = st.tabs([
        # --- YENİ & ÖZEL ARAÇLAR (KIRMIZI) ---
        "📍 Yarıçap (Radar) [NEW]", 
        "🚗 Rota Planlayıcı [NEW]",
        "🤖 Robo-Yönetici [NEW]",
        "💸 Vergi Zincir Analizi [NEW]", 
        "🔍 Detaylı Arama [NEW]", 
        # --- STANDART ANALİZLER (MAVİ) ---
        "📊 Bölgesel & Durum",
        "⚡ Hızlı Analiz",      
        "⚔️ Karşılaştırma", 
        "🔮 Simülasyon",          
